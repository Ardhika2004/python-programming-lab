length_of_rectanglular_area_in_feet=eval(input("Enter the length of the rectangular floor : "))
breadth_of_the_rectangular_area_in_feet=eval(input("Enter the breadth of the the rectangular floor : "))
...
Total_area_of_rectangular_floor_in_square_feet=(length_of_rectanglular_area_in_feet*breadth_of_the_rectangular_area_in_feet)
